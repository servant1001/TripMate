import type { Expense, ItineraryItem, Settlement, TodoItem, Trip } from '../types'
import { database, firebaseEnabled } from './firebase'
import { get, ref, set, update } from 'firebase/database'

const key = 'tripmate-data-v1'
type Data = { trips: Trip[]; itinerary: ItineraryItem[]; expenses: Expense[]; settlements: Settlement[]; todos: TodoItem[]; categoryBudgets: Record<string, Record<string, number>> }
const seed: Data = { trips: [], itinerary: [], expenses: [], settlements: [], todos: [], categoryBudgets: {} }
