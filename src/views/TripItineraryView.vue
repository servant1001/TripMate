...
const itineraryGroup = reactive({ date: '', time: '', endTime: '', title: '', location: '', mapUrl: '', website: '', note: '', cardVisibility: 'shared' as ItineraryVisibility, childVisibility: 'shared' as ItineraryVisibility })
