...
@media(max-width:720px){
  ...
  .itinerary-group-clear,
  .itinerary-group-create,
  .itinerary-group-delete,
  .itinerary-group-add-button,
  .itinerary-group-toggle{
