...
<TripItineraryView v-if="activeTripTab === 'overview' || activeTripTab === 'itinerary'" :trip="current" :items="currentItems" :days="itineraryDays" :personal-items="currentPersonalItems" :shopping-items="currentShoppingItems" :can-edit="canEditTrip" :sorting-enabled="itinerarySortingEnabled" :format-date="formatItineraryDate" :duration="itineraryDuration" :time-warning="itineraryTimeWarning" :maps-url="mapsUrl" @add="openNewItemForm" @add-after="openItemFormAfter" @add-personal="openPersonalItemForm" @toggle="toggleItinerary" @edit="openItemFormForEdit" @remove="removeItem" @toggle-sorting="toggleItinerarySorting" @sort="sortItineraryItems" @sort-group="sortGroupItineraryItems" @sort-personal="sortPersonalItineraryItems" @move="moveItineraryItem" />
        <TripMapView v-if="activeTripTab === 'map'" :days="itineraryDays" :format-date="formatItineraryDate" :maps-url="mapsUrl" />
        <TripExpensesView v-if="activeTripTab === 'overview' || activeTripTab === 'expenses'" :trip="current" :expenses="currentExpenses" :total="total" :my-paid="myPaid" :my-balance="myBalance" :personal-budget="personalBudget" :personal-spent="myExpense" :category-budgets="categoryBudgetSummary" :daily-budget="dailyBudget" :daily-expenses="dailyExpenseSummary" :can-set-personal-budget="Boolean(activeMemberId)" :can-manage-category-budgets="canEditTripSettings" :can-edit="canEditTrip" :user-id="user?.uid || current.ownerId" :payer-label="expensePayerLabel" :split-label="expenseSplitLabel" :participant-count="expenseParticipantCount" :share="expenseShare" @set-personal-budget="openPersonalBudgetForm" @manage-category-budgets="openCategoryBudgetForm" @manage-daily-budget="openDailyBudgetForm" />
